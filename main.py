...
def show_graph_explanation(text=None):
    ...
    나중에 그래프를 추가할 때도 이 함수를 재사용할 수 있습니다.
    """
...
# Plotly의 기본 범례 기능을 사용하므로
# 범례의 영화명을 클릭하면 해당 선을 숨기거나 다시 표시할 수 있습니다.
st.plotly_chart(
    fig_top5,
    use_container_width=True,
)
...
show_graph_explanation(
    ...
    "시간에 따라 관객 규모가 어떻게 변했는지 서로 비교할 수 있습니다."
)
